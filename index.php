    ...
    <div class="header-content">
      <div class="row">
        <div class="col-md-5 my-auto mx-auto" data-aos="fade-right">
          <h2>Toko Ritel</h2>
          <p>
            Toko Ritel adalah aplikasi belanja online terbesar di Indonesia.
  ...
  <section class="footer bg-dark" id="contact">
    <div class="footer-content">
      ...
      <div class="row">
        ...
        <div class="col-md-5 my-3 mx-auto" data-aos="fade-in">
          <h4 class="text-light text-poppins font-weight-bold">Toko Ritel</h4>
          <p class="d-block font-weight-light text-light">
            Toko Ritel adalah aplikasi berbelanja online dengan fasilitas memadai
          </p>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <div class="d-flex justify-content-center align-items-center text-center flex-column mx-auto">
            <span class="d-block text-light">© Copyright <strong>2022</strong>. TUGAS BESAR BASIS DATA</span>
          </div>
        </div>
      </div>
    </div>
